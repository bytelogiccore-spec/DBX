...
- **라이선스**: Apache-2.0
- **버전**: 1.x
- **용도**: 분산 Grid 통신을 위한 QUIC 트랜스포트
- **저장소**: https://github.com/aws/s2n-quic
...
- **라이선스**: MIT OR Apache-2.0 OR Zlib
- **버전**: 0.7
- **용도**: 심플한 SIMD 추상화 레이어
- **저장소**: https://github.com/Lokathor/wide
...
- **라이선스**: MIT
- **버전**: 6.0
- **용도**: 분산 티어링을 위한 삭제 정정 부호(Erasure Coding)
- **저장소**: https://github.com/darrenldl/reed-solomon-erasure
...
- **라이선스**: MIT OR Apache-2.0
- **버전**: 0.12 / 0.4
- **용도**: 데이터 수명 주기(Lifecycle) 작업 스케줄링
- **저장소**: https://github.com/zslayton/cron
...
- **라이선스**: MIT
- **버전**: 1.x
- **용도**: 비동기 런타임 및 네트워크 통신
- **저장소**: https://github.com/tokio-rs/tokio
...
- 테스트 및 벤치마크 전용 의존성(Criterion, Proptest, rusqlite, redb 등)은 핵심 라이브러리에서 분리되었으므로 본 목록에서 제외되었습니다.

---

*최종 업데이트: 2026-04-03 (v0.2.0-beta)*

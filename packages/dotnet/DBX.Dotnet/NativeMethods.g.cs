...
namespace DBX.Dotnet
{
    public static unsafe partial class NativeMethods
    {
        ...
        // DDL API Operations
        [DllImport(__DllName, EntryPoint = "dbx_drop_table", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int dbx_drop_table(DbxHandle* handle, byte* table);

        [DllImport(__DllName, EntryPoint = "dbx_table_exists", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int dbx_table_exists(DbxHandle* handle, byte* table);

        [DllImport(__DllName, EntryPoint = "dbx_list_tables", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int dbx_list_tables(DbxHandle* handle, DbxStringList** out_list);

...
pub enum ReplicationMessage {
    ...
    VoteRequest { node_id: u32, term: u64, last_lsn: u64 },
    /// 마스터 승격(Failover) 투표 응답
    /// `voter_id`: 투표한 노드 ID (집계용)
    VoteResponse { node_id: u32, voter_id: u32, term: u64, granted: bool },
    /// 새 마스터 승격 알림
...
mod tests {
    ...
    #[test]
    fn test_heartbeat() {
        let msg = ReplicationMessage::Heartbeat { node_id: 1, lsn: 100 };

        ...
        group.bench_with_input(BenchmarkId::from_parameter(size), size, |b, &size| {
            b.iter_batched(
                ...
                |db| {
                    ...
                    let result = db.execute_sql(black_box("UPDATE users SET age = 26 WHERE age = 25"));
                    black_box(result)
                },
                criterion::BatchSize::SmallInput,
            );
        ...
        group.bench_with_input(BenchmarkId::from_parameter(size), size, |b, &size| {
            b.iter_batched(
                ...
                |db| {
                    ...
                    let result = db.execute_sql(black_box("UPDATE users SET age = 50 WHERE age > 45"));
                    black_box(result)
                },
                criterion::BatchSize::SmallInput,
            );
        ...
        group.bench_with_input(BenchmarkId::from_parameter(size), size, |b, &size| {
            b.iter_batched(
                ...
                |db| {
                    ...
                    let result = db.execute_sql(black_box(
                        "DELETE FROM users WHERE age < 25 OR age > 65"
                    ));
                    black_box(result)
                },
                criterion::BatchSize::SmallInput,
